...
//                int color = Color.argb(255, (int) segment[i], rnd.nextInt(256), rnd.nextInt(256));
    ...
    private int[] getColor(){
        int[] colorValues = new int[this.data.size()];
        for (int i = 0; i < this.data.size(); i++) {
            colorValues[i] = this.data.get(i).getColor();
        }
        return colorValues;
    }
